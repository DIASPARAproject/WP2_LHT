...
Diadromous species such as European eel and Atlantic salmon exhibit large variation in life histories across their distribution range correlated to environmental gradients [REF]{>>for eel: 10.1111/j.1467-2979.2010.00400.x; 10.2307/5507; 10.1139/cjfas-2016-0214<<}. Furthermore, they are exposed to multiple anthropogenic stressors across habitats and may be particularly vulnerable to climate change [@moll2024] affecting their life histories. 
...
3.1 Life cycle of the European eel
European eel is a panmictic, catadromous and semelparous species, meaning there is only one
single stock and adult fish migrate to the sea, where they die after spawning. Hatched in the
Sargasso Sea in the Central North west Atlantic, leptocephalus larvae drift towards North Africa
and the European continent. At the shelf, they metamorphose into glass eels and settle in marine,
coastal and freshwater habitats; typically from winter to spring. Once settled, eels become
pigmented yellow eels a growth stage that can last from few years (southern range) to several
decades (northern range). At the end of their continental life, eels become so called silver eels
with larger eyes, longer fins and silver colour, emigrating from their continental habitats, mostly
during autumn, to spawn in the Sargasso Sea where they die.
3.2 Scope of LHT analyses and data summary
3.2.1 Life history traits prioritized for analysis
The following analyses on key LHT are prioritized for the European eel in DIASPARA work
package 2:
1. Spatiotemporal variations in eel growth
...
The red lines show {>>red correct?<<} basin specific growth curves. {>>in Baltic22to26 and 27to29 you have basins that behave completely differently than the others, could you comment on that?<<}
...
We modeled body length at silvering using hierarchical lognormal regression accounting for differences among ecoregions and temporal variation across years. Covariate effects of sex and region specific temperature were included in the model.
...
Female median length at silvering over time by ecoregion. Boxes deliminate the interquartile range, whiskers extend beyond that range and outliers are excluded. The line shows the global female median by year.
:::

::: {#fig-sil2}
![](silv_lf.png){width=80%}

Male median length at silvering over time by ecoregion. Boxes delimit the interquartile range, whiskers extend beyond that range and outliers are excluded. The line shows the global male median by year.
:::

## Salmon

FROM THE INVENTORY deliverable:
...
The analysis of spatiotemporal variation in key LHT for Atlantic salmon in DIASPARA work package 2 will prioritize two questions:
1.	How does growth at sea change over time and space and what is the influence of those changes on the fecundity of returning adults?
2.	How does growth during the juvenile phase change over time and space and what is the consequences of those changes on parr and smolt length and age composition?
From this priority, the summary presented here focuses on data on length and age of parr and smolts (freshwater juvenile individuals) and spawning fish (adult individuals caught in, or in proximity to their river of origin) and fecundity (number of eggs) and length of spawning females.>>

### Spatiotemporal variation in salmon length at age

We built a spatiotemporal model of individual body length as a function of age using a biphasic growth model. A biphasic growth model, separating life stages,  is  suitable for salmon as growth is strongly habitat dependent [@nater2018]. The model predicts age dependent length increments of cohorts recursively using a linear function for the freshwater (juvenile) phase and the von Bertalanffy growth function for the sea phase.
...
Latitudinal expected patterns are evident, r_j decreasing with latitude, Linf increasing with latitude, 
...
Salmon length at hatching ($L_b$) over spatial units. Regions are ordered by their mean laititude. Note that spatial units Adour and Baltic Sea AU:NA lack freshwater observation data. 
:::
